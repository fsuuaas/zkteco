...
namespace Fsuuaas\Zkteco\Lib;

use ErrorException;
use Exception;
use Fsuuaas\Zkteco\Lib\Helper\Attendance;
use Fsuuaas\Zkteco\Lib\Helper\Device;
use Fsuuaas\Zkteco\Lib\Helper\Face;
use Fsuuaas\Zkteco\Lib\Helper\Fingerprint;
use Fsuuaas\Zkteco\Lib\Helper\Os;
use Fsuuaas\Zkteco\Lib\Helper\Pin;
use Fsuuaas\Zkteco\Lib\Helper\Platform;
use Fsuuaas\Zkteco\Lib\Helper\SerialNumber;
use Fsuuaas\Zkteco\Lib\Helper\Ssr;
use Fsuuaas\Zkteco\Lib\Helper\Time;
use Fsuuaas\Zkteco\Lib\Helper\User;
use Fsuuaas\Zkteco\Lib\Helper\Util;
use Fsuuaas\Zkteco\Lib\Helper\Connect;
use Fsuuaas\Zkteco\Lib\Helper\Version;
use Fsuuaas\Zkteco\Lib\Helper\WorkCode;
...
class ZKTeco{
  ...
  {
    return Device::writeLCD($this, 2, "Sharif Uddin Ahamed");
  }
}